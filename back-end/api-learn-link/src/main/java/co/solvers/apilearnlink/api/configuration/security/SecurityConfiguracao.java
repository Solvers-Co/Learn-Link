...
public class SecurityConfiguracao {
    ...
    private static final AntPathRequestMatcher[] URLS_PERMITIDAS = {
            ...
            new AntPathRequestMatcher("/publicacoes/denuncias/txt"),
            new AntPathRequestMatcher("/publicacoes/denuncias/json"),
            new AntPathRequestMatcher("/publicacoes/denuncias/xml"),
            new AntPathRequestMatcher("/publicacoes/denuncias/parquet"),
            new AntPathRequestMatcher("/publicacoes/{id}/arquivar"),
            ...
            new AntPathRequestMatcher("/publicacoes/denuncias/ordenadasPorIa"),
            new AntPathRequestMatcher("/publicacoes/buscar-imagem/{id}"),
            ...
            new AntPathRequestMatcher("/usuarios/buscar-imagem-perfil/{id}"),
