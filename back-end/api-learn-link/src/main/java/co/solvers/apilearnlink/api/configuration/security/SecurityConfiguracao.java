...
public class SecurityConfiguracao {
    ...
    private static final AntPathRequestMatcher[] URLS_PERMITIDAS = {
            ...
            new AntPathRequestMatcher("/usuarios/buscar-todos-os-usuarios}"),
            new AntPathRequestMatcher("/usuarios/usuarios-ativos}"),
            new AntPathRequestMatcher("/usuarios/usuarios-pendentes}"),
            new AntPathRequestMatcher("/usuarios/usuarios-negados}"),
